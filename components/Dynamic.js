  ...
  return (
    <>
      <div className="container page-content">
        <h1 className="mt-5">
          Air France Flight Reservations on MyFlightSearch
        </h1>
        <p className="page-para">
          ...
          and Paris Orly Airport serves as its main hub and operates flights to
          over 200 destinations. These airports cover major cities like
          Amsterdam, Bangkok, Chicago, Boston Dublin, Delhi, Hong Kong and
          London. With fleet size of over 200, the airline code share agreement
          with airlines, including, Eithad Airways, Jet Airways, Bangkok
          Airways, Alaska Airlines, Georgian Airways and Kenya Airways
        </p>
        ...
        <ul className="flight-list">
          ...
          <li>
            Airline offers a travel kit, lounge wear, slippers and dust bags for
            shoes once on board.
          </li>
          <li>
          ...
          <li>
            Serves lip-smacking meals prepared by top French Chefs and also get
            chance to try new flavors by choosing your meal in advance. Includes
            a wide variety of wines as well.
          </li>
          <li>
        ...
        <ul className="flight-list">
          ...
          <li>
            Personal screens which comprises 500 hours of different programming.
            Along with it, you can use Air France App for tablets and download
            your favorite newspapers and magazines free of cost.
          </li>
          <li>
          ...
          <li>
            ...
            Also, the middle seat is replaced by a tray table where you can work
            effortlessly.
          </li>
          <li>
        ...
        <ul className="flight-list">
          <li>
            Economy class is all about comfort and relaxation. Enjoy your flight
            with a personal video comprising various movies, music and games
          </li>
          <li>
          ...
          <li>
            Basic amenities like sleep mask, ear plugs and refreshing towel free
            of cost
          </li>
          <li>
        ...
        <p className="page-para">
          ...
          facility. You just need to check-in online before 30 hours prior your
          flight departure. You can also choose your desired seat depending on
          your convenience. Once it is done. You only have to leave your baggage
          at the baggage counter.
        </p>
        <h4>FLYING BLUE</h4>
        <p className="page-para mb-5">
          Flying Blue is the frequent flyer program of the Air France-KLM that
          lets its loyal and esteemed customers benefit every time they fly with
          the airline. Membership in this program is free; it awards points
          depending on the miles travelled and class of service. There are
          basically four levels under this program namely Ivory, Silver, Gold
          and Platinum.
        </p>
        ...
        <div className="container airports-grid mb-3">
          <div className="row">
            <div
              className="col-md-2 effect-span d-flex flex-column "
              style={{ gap: "12px" }}
            >
            ...
            <div
              className="col-md-6 effect-span d-flex flex-column"
              style={{ gap: "12px" }}
            >
